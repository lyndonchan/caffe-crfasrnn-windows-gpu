...
template void PrintBlob(const Blob<float>* blob, bool print_diff, const char *info);

template void PrintBlob(const Blob<double>* blob, bool print_diff, const char *info);
...
template void FillWithMax(Blob<float>* const blob, float max_value);
template void FillWithMax(Blob<double>* const blob, float max_value);
